  ...
  this.initialize = function(databattle) {
    ...
    for(var i=0;i<13;i++) {
      ...
      for(var j=0;j<16;j++) {
        ...
        /*if('number' === typeof cell.occupant) {
          ...
          el_sector.setAttribute('spybot-databattle-unit-class', databattle.units[cell.occupant].name);
    ...
    function change() {
      ...
      for(var i=0;i<16*13;i++) {
        ...
        /* if occupancy has changed or unit-head status might have changed */
